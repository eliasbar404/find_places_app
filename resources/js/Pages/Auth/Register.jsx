    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div>
                    <InputLabel htmlFor="name" value="Name" className='font-mono'/>
                ...
                <div className="mt-4">
                    <InputLabel htmlFor="password_confirmation" value="Confirm Password"  className='font-mono'/>
                ...
                <div className="flex items-center justify-end mt-4">
                    ...
                    <PrimaryButton className="ms-4 font-mono  bg-amber-600 hover:bg-amber-800" disabled={processing}>
                        Register
                    </PrimaryButton>
                </div>
            </form>
